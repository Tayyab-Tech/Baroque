    ...
    <Header />
      ...
      <div className="text-center   flex justify-center   ">
        <div className="w-3/4 mb-16  font-sans">
          <h3 className="text-left tracking-widest text-xl uppercase	">
            OVERVIEW
          </h3>

          <p className=" tracking-wide  text-left text-base ">
            This website is operated by BAROQUE. Throughout the site, the terms
            “we”, “us” and “our” refer to BAROQUE. BAROQUE offers this website,
          ...
          <p className=" tracking-wider  text-left text-base  mt-6">
          ...
          <h3 className="text-left tracking-widest font-bold text-base 	">
          ...
          <Link to="/Refundpolicy"><p className="underline  text-left text-base  ">
            https://baroque.pk/policies/refund-policy
        ...
        <p className="text-left text-base mt-6 ">
            For more details, please review our Refund Policy:
            <Link to ="/Refundpolicy" className="underline">  https://baroque.pk/policies/refund-policy
          </Link>
          </p>
          <h3 className="text-left tracking-widest font-bold text-base 	">
          ...
          <p className="tracking-wide  text-left text-base mt-6 ">
            ...
            https://baroque.pk/policies/privacy-policy
          </p>
          ...
          <p className="tracking-wide  text-left text-base mt-6 ">
            ...
            In no case shall BAROQUE, our directors, officers, employees,
          ...
          <p className="tracking-wide  text-left text-base mt-6 ">
            ...
            You agree to indemnify, defend and hold harmless BAROQUE and our
          ...
          <p className="tracking-wide  text-left text-base mt-6 ">
            ...
            accordance with the laws of Pakistan with the primary Jurisdiction
            being in Lahore.
          </p>
          ...
          <p className="tracking-wide  text-left text-base  ">
            Bilal Textile, Tariq Ismail Road, Raiwind Road, Lahore, PK
          </p>
          <p className="tracking-wide  text-left text-base  ">
            +923257001111
          </p>
